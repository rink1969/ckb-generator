...
#define MOL_HeaderVec(idx)                                               MolFixVec,264,idx
...
#define MOL_WitnessVec(idx)                                              MolDynVec,idx
...
#define MOL_Witness(idx)                                                 MolDynVec,idx
...
#define MOL_RawHeader_version()                                          MolStruct,256,0,4
#define MOL_RawHeader_uncles_count()                                     MolStruct,256,4,4
#define MOL_RawHeader_timestamp()                                        MolStruct,256,8,8
#define MOL_RawHeader_number()                                           MolStruct,256,16,8
#define MOL_RawHeader_epoch()                                            MolStruct,256,24,8
#define MOL_RawHeader_parent_hash()                                      MolStruct,256,32,32
#define MOL_RawHeader_transactions_root()                                MolStruct,256,64,32
#define MOL_RawHeader_witnesses_root()                                   MolStruct,256,96,32
#define MOL_RawHeader_proposals_hash()                                   MolStruct,256,128,32
#define MOL_RawHeader_difficulty()                                       MolStruct,256,160,32
#define MOL_RawHeader_uncles_hash()                                      MolStruct,256,192,32
#define MOL_RawHeader_dao()                                              MolStruct,256,224,32
#define MOL_Header_raw()                                                 MolStruct,264,0,256
#define MOL_Header_nonce()                                               MolStruct,264,256,8
...
#define MOL_EpochExt_difficulty()                                        MolTable ,8,2
#define MOL_EpochExt_number()                                            MolTable ,8,3
#define MOL_EpochExt_block_reward()                                      MolTable ,8,4
...
#define MOL_CellMeta_data_hash()                                         MolStruct,40,0,32
#define MOL_CellMeta_capacity()                                          MolStruct,40,32,8
...
#define MOL_GetBlockTransactions_block_hash()                            MolTable ,2,0
#define MOL_GetBlockTransactions_indexes()                               MolTable ,2,1
#define MOL_BlockTransactions_block_hash()                               MolTable ,2,0
#define MOL_BlockTransactions_transactions()                             MolTable ,2,1
